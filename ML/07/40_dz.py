...
# ВЫВОДЫ:
# log_likelihood и inertia нельзя напрямую сравнивать, так как это разные метрики. 
# Но обе говорят о качестве модели: чем выше log_likelihood, тем лучше; чем ниже inertia, тем лучше.
